...
from src.services.exceptions import ImageValidationError
from src.services.image_service import ImageUploadService


class TestImageUploadService:
    @pytest.fixture
    def image_service(self, tmp_path) -> ImageUploadService:
    ...
    def test_too_large_file_size(self, image_service: ImageUploadService):
        file = MagicMock()
