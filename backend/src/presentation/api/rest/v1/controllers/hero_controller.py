...
async def get_heroes_from_external_api(
    ...
    return [
        presentation_mapper.to_external_api_hero_response_scheme(hero_dto)
...
async def get_heroes(
    ...
    return [presentation_mapper.to_response_scheme(hero_dto) for hero_dto in hero_dtos]
...
async def upload_hero_image(
    image_service: FromDishka[ImageUploadServiceProtocol],
    ...
    update_hero_dto = presentation_mapper.to_update_hero_dto(uploaded_img_url=image_url)
